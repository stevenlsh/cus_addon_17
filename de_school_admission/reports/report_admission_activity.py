...
class ActivityReport(models.Model):
    ...
    _name = "oe.admission.activity.report"
    _auto = False
    _description = "Admission Activity Analysis"
    _rec_name = 'id'
    ...
    def _join(self):
        return """
            JOIN oe_admission AS l ON m.res_id = l.id
        """
    ...
    def _where(self):
        ...
        return """
            WHERE
                m.model = 'oe.admission' AND (m.mail_activity_type_id IS NOT NULL OR m.subtype_id = %s)
